...
SECRET_KEY = 'django-insecure-f6p1q_)o_-ml5)zy+nk=ncth4c+!73pjhv^q=&w$5z=ce_e)dy'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'DropOutDB',      # the database you created in pgAdmin
        'USER': 'postgres',     # the username you set in pgAdmin
